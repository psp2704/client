  ...
  return (
    <>
      <div className="px-4 py-4 max-w-4xl mx-auto mb-8 text-center">
        <h3 className=" text-3xl md:text-4xl leading-tight text-coolGray-900 font-bold tracking-tighter">
          Total Income/Expenses of All Accounts
        </h3>
        <p className=" first-line:text-lg md:text-xl text-coolGray-500 font-medium">
